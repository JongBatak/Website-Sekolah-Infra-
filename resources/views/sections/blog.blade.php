      ...
      <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
          <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 flex flex-col h-full">
            <img src="assets/blog/nobar.png" alt="Nonton Bareng" class="w-full h-52 object-cover">
        ...
        <div class="swiper-slide">
          <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 flex flex-col h-full">
            <img src="assets/blog/rapat-guru.png" alt="Rapat Guru" class="w-full h-52 object-cover">
            <div class="p-6 flex flex-col justify-between h-full">
              <div>
                <h3 class="font-bold text-lg text-gray-900 mb-2">
        ...
        <div class="swiper-slide">
          <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 flex flex-col h-full">
            <img src="assets/blog/penghargaan-guru.png" alt="Penghargaan Guru" class="w-full h-52 object-cover">
            <div class="p-6 flex flex-col justify-between h-full">
              <div>
                <h3 class="font-bold text-lg text-gray-900 mb-2">
