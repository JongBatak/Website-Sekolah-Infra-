...
<!-- ================= NAVBAR ================= -->
<header id="navbar"
  class="fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-transparent mt-10">
  <div class="max-w-7xl mx-auto flex items-center justify-between px-4 md:px-8 py-3">
...
<a href="#"
  ...
  <!-- Mobile Dropdown Menu -->
  <div id="mobile-menu" class="hidden md:hidden bg-white shadow-lg">
    <a href="{{ route('home') }}" class="block px-6 py-3 text-gray-700 hover:bg-orange-500 hover:text-white">Beranda</a>
    <a href="#" class="block px-6 py-3 text-gray-700 hover:bg-orange-500 hover:text-white">Tentang</a>
    <a href="#" class="block px-6 py-3 text-gray-700 hover:bg-orange-500 hover:text-white">Program</a>
    <a href="#" class="block px-6 py-3 text-gray-700 hover:bg-orange-500 hover:text-white">Dokumentasi</a>
    <a href="#" class="block px-6 py-3 text-gray-700 hover:bg-orange-500 hover:text-white">Pendaftaran</a>
    <a href="#" class="block px-6 py-3 text-gray-700 hover:bg-orange-500 hover:text-white">PresmaLance</a>
  </div>
</header>
...
<script>
  ...
  window.addEventListener("scroll", () => {
    const links = navbar.querySelectorAll("nav a:not(.dropdown-link)"); 
    if (window.scrollY > 50) {
      navbar.classList.remove("bg-transparent", "mt-10");
      ...
      navbar.classList.add("bg-transparent", "mt-10");
